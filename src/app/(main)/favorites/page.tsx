...
export default function Page() {
  return (
    <div className="container mx-auto px-4 py-12 md:py-24 max-w-4xl min-h-[60vh]">
      <div className="mb-12">
        <h1 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">Избранное</h1>
        <p className="text-lg text-muted-foreground">Здесь будут сохраненные вами товары</p>
      </div>
      <div className="flex flex-col items-center justify-center text-center py-20 border rounded-3xl bg-muted/20 px-4">
        ...
        <p className="text-muted-foreground mb-8 max-w-sm">Здесь будут сохраненные вами товары</p>
