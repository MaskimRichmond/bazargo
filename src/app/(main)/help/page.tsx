...
export default function Page() {
  return (
    <div className="container mx-auto px-4 py-12 md:py-24 max-w-4xl min-h-[60vh]">
      <div className="mb-12">
        <h1 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">Помощь</h1>
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none prose-p:leading-relaxed prose-headings:font-bold">
        <p>
          Это заглушка для страницы "Помощь". Реальный текст будет добавлен позже.
        </p>
        <h3>Раздел 1</h3>
        <p>
